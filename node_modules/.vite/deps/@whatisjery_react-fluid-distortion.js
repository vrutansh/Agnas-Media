...
import {
  ...
  useDrag,
  useFBO
} from "./chunk-PP56JPS7.js";
import "./chunk-3K3JPHCP.js";
import {
  require_react_dom
} from "./chunk-NELPYFXO.js";
import "./chunk-HAOBZU6R.js";
import {
  _extends,
  create,
  createPortal,
...
var require_is_plain_object = __commonJS({
  "node_modules/is-plain-object/index.js"(exports, module) {
    ...
    function isObjectObject(o5) {
      return isObject3(o5) === true && Object.prototype.toString.call(o5) === "[object Object]";
    }
    module.exports = function isPlainObject(o5) {
      var ctor, prot;
      if (isObjectObject(o5) === false)
        return false;
      ctor = o5.constructor;
...
var require_extend_shallow2 = __commonJS({
  "node_modules/extend-shallow/index.js"(exports, module) {
    ...
    module.exports = function extend(o5) {
      if (!isObject3(o5)) {
        o5 = {};
      }
...
// node_modules/@whatisjery/react-fluid-distortion/dist/index.es.js
...
var o = () => {
  ...
  return (t4, r4, ...n4) => {
    const o5 = ((e5) => JSON.stringify(e5, i))(t4);
    return o5 in e4 ? e4[o5] : e4[o5] = r4(t4, ...n4);
  };
};
...
var S = (e4) => e4 ? e4 + "-" : "";
var k = (e4, t4, r4) => e4.replace(/([+-])?((?:\d+(?:\.\d*)?|\.\d+)(?:[Ee][+-]?\d+)?)?(\$|--)([$\w-]+)/g, (e5, n4, i4, o5, l4) => "$" == o5 == !!i4 ? e5 : (n4 || "--" == o5 ? "calc(" : "") + "var(--" + ("$" === o5 ? S(t4) + (l4.includes("$") ? "" : S(r4)) + l4.replace(/\$/g, "-") : l4) + ")" + (n4 || "--" == o5 ? "*" + (n4 || "") + (i4 || "1") + ")" : ""));
var y = /\s*,\s*(?![^()]*\))/;
    ...
    const p4 = (e6) => {
      for (c4 in e6) {
        ...
        for (g4 of z2) {
          ...
          if (R3 && (b4 = c4.slice(1) in n4.media ? "@media " + n4.media[c4.slice(1)] : c4, c4 = b4.replace(/\(\s*([\w-]+)\s*(=|<|<=|>|>=)\s*([\w-]+)\s*(?:(<|<=|>|>=)\s*([\w-]+)\s*)?\)/g, (e8, t6, r6, n5, i5, o6) => {
            const l5 = h.test(t6), s5 = 0.0625 * (l5 ? -1 : 1), [a5, c5] = l5 ? [n5, t6] : [t6, n5];
            return "(" + ("=" === r6[0] ? "" : ">" === r6[0] === l5 ? "max-" : "min-") + a5 + ":" + ("=" !== r6[0] && 1 === r6.length ? c5.replace(h, (e9, t7, n6) => Number(t7) + s5 * (">" === r6 ? 1 : -1) + n6) : c5) + (i5 ? ") and (" + (">" === i5[0] ? "min-" : "max-") + a5 + ":" + (1 === i5.length ? o6.replace(h, (e9, t7, r7) => Number(t7) + s5 * (">" === i5 ? -1 : 1) + r7) : o6) : "") + ")";
          })), z3) {
            const e8 = R3 ? r5.concat(c4) : [...r5], n5 = R3 ? [...t5] : f(t5, c4.split(y));
            void 0 !== o5 && i4(x(...o5)), o5 = void 0, a4(g4, n5, e8);
          } else
            void 0 === o5 && (o5 = [[], t5, r5]), c4 = R3 || 36 !== c4.charCodeAt(0) ? c4 : `--${S(n4.prefix)}${c4.slice(1).replace(/\$/g, "-")}`, g4 = z3 ? g4 : "number" == typeof g4 ? g4 && e7 in I ? String(g4) + "px" : String(g4) : k(m(e7, null == g4 ? "" : g4), n4.prefix, n4.themeMap[e7]), o5[0].push(`${R3 ? `${c4} ` : `${d(c4)}:`}${g4}`);
        }
      }
      var b4, $4;
    };
    p4(e5), void 0 !== o5 && i4(x(...o5)), o5 = void 0;
  };
  a4(e4, t4, r4);
};
  ...
  const r4 = () => {
    ...
    return [].map.call(e5, (r5, n5) => {
      ...
      if (i4.startsWith("--sxs"))
        return "";
      if (e5[n5 - 1] && (o5 = e5[n5 - 1].cssText).startsWith("--sxs")) {
    ...
    for (const e5 of i4)
      if (j(e5)) {
        for (let i5 = 0, o6 = e5.cssRules; o6[i5]; ++i5) {
          const l5 = Object(o6[i5]);
          if (1 !== l5.type)
            continue;
          const s4 = Object(o6[i5 + 1]);
          if (4 !== s4.type)
            continue;
          ++i5;
          const { cssText: a4 } = l5;
    ...
    const { sheet: o5, rules: l4 } = t4;
    for (let e5 = W.length - 1; e5 >= 0; --e5) {
      const t5 = W[e5];
      if (!l4[t5]) {
        const r5 = W[e5 + 1], n5 = l4[r5] ? l4[r5].index : o5.cssRules.length;
        o5.insertRule("@media{}", n5), o5.insertRule(`--sxs{--sxs:${e5}}`, n5), l4[t5] = { group: o5.cssRules[n5 + 1], index: n5, cache: /* @__PURE__ */ new Set([e5]) };
      }
      v(l4[t5]);
    }
  };
...
var C = ({ variants: e4, compoundVariants: t4, defaultVariants: r4, ...n4 }, i4) => {
  const o5 = `${S(i4.prefix)}c-${z(n4)}`, l4 = [], s4 = [], d4 = /* @__PURE__ */ Object.create(null), g4 = [];
  for (const e5 in r4)
    d4[e5] = String(r4[e5]);
  ...
  return [o5, n4, l4, s4, d4, g4];
};
var P = (e4, t4, r4) => {
  const [n4, i4, o5, a4] = L(t4.composers), c4 = "function" == typeof t4.type || t4.type.$$typeof ? ((e5) => {
    function t5() {
    ...
    for (const e5 in o5)
      if (delete p5[e5], e5 in l4) {
        let t5 = l4[e5];
        "object" == typeof t5 && t5 ? u4[e5] = { "@initial": o5[e5], ...t5 } : (t5 = String(t5), u4[e5] = "undefined" !== t5 || a4.has(e5) ? t5 : o5[e5]);
      } else
        u4[e5] = o5[e5];
    const h4 = /* @__PURE__ */ new Set([...i4]);
    for (const [n5, i5, o6, l5] of t4.composers) {
      r4.rules.styled.cache.has(n5) || (r4.rules.styled.cache.add(n5), $(i5, [`.${n5}`], [], e4, (e5) => {
        d4.styled.apply(e5);
      }));
      const t5 = O(o6, u4, e4.media), s5 = O(l5, u4, e4.media, true);
      for (const i6 of t5)
        if (void 0 !== i6)
          for (const [t6, o7, l6] of i6) {
            const i7 = `${n5}-${z(o7)}-${t6}`;
            h4.add(i7);
            const s6 = (l6 ? r4.rules.resonevar : r4.rules.onevar).cache, a5 = l6 ? d4.resonevar : d4.onevar;
            s6.has(i7) || (s6.add(i7), $(o7, [`.${i7}`], [], e4, (e5) => {
              a5.apply(e5);
            }));
          }
      for (const t6 of s5)
        if (void 0 !== t6)
          for (const [i6, o7] of t6) {
            const t7 = `${n5}-${z(o7)}-${i6}`;
            h4.add(t7), r4.rules.allvar.cache.has(t7) || (r4.rules.allvar.cache.add(t7), $(o7, [`.${t7}`], [], e4, (e5) => {
              d4.allvar.apply(e5);
            }));
          }
    }
...
var L = (e4) => {
  let t4 = "";
  const r4 = [], n4 = {}, i4 = [];
  for (const [o5, , , , l4, s4] of e4) {
    "" === t4 && (t4 = o5), r4.push(o5), i4.push(...s4);
    for (const e5 in l4) {
      const t5 = l4[e5];
...
var O = (e4, t4, r4, n4) => {
  ...
  e:
    for (let [o5, l4, s4] of e4) {
      ...
      (i4[a4] = i4[a4] || []).push([n4 ? "cv" : `${e5}-${o5[e5]}`, l4, c4]);
    }
  return i4;
};
var A = {};
...
var J = (e4, t4) => F(e4, () => (r4, n4) => {
  ...
  const i4 = `.${r4 = (r4 = "string" == typeof r4 ? r4 : "") || `${S(e4.prefix)}t-${z(n4)}`}`, o5 = {}, l4 = [];
  for (const t5 in n4) {
    o5[t5] = {};
    for (const r5 in n4[t5]) {
      const i5 = `--${S(e4.prefix)}${t5}-${r5}`, s5 = k(String(n4[t5][r5]), e4.prefix, t5);
      o5[t5][r5] = new G(r5, s5, t5, e4.prefix), l4.push(`${i5}:${s5}`);
    }
  }
  const s4 = () => {
...
var q = (e4) => {
  const t4 = ((e5) => {
    ...
    const r4 = U(e5, (e6) => {
      t5 = true;
      const r5 = "prefix" in (e6 = "object" == typeof e6 && e6 || {}) ? String(e6.prefix) : "", i4 = "object" == typeof e6.media && e6.media || {}, o5 = "object" == typeof e6.root ? e6.root || null : globalThis.document || null, l4 = "object" == typeof e6.theme && e6.theme || {}, s4 = { prefix: r5, media: i4, theme: l4, themeMap: "object" == typeof e6.themeMap && e6.themeMap || { ...n }, utils: "object" == typeof e6.utils && e6.utils || {} }, a4 = E(o5), c4 = { css: M(s4, a4), globalCss: D(s4, a4), keyframes: V(s4, a4), createTheme: J(s4, a4), reset() {
  ...
  return t4.styled = (({ config: e5, sheet: t5 }) => Y(e5, () => {
    ...
    return (...e6) => {
      const t6 = r4(...e6), n4 = t6[l].type, i4 = import_react5.default.forwardRef((e7, r5) => {
        const i5 = e7 && e7.as || n4, { props: o5, deferredInjector: l4 } = t6(e7);
        return delete o5.as, o5.ref = r5, l4 ? import_react5.default.createElement(import_react5.default.Fragment, null, import_react5.default.createElement(i5, o5), import_react5.default.createElement(l4, null)) : import_react5.default.createElement(i5, o5);
      });
...
var schema$1 = (o5) => v8n_esm_default().string().test(o5);
var sanitize$1 = (v4) => {
  if (typeof v4 !== "string")
...
var schema = (o5) => v8n_esm_default().boolean().test(o5);
var sanitize = (v4) => {
...
function getVectorSchema(dimension) {
  ...
  const isVectorObject = (o5) => {
    if (!o5 || typeof o5 !== "object")
      return false;
    const values = Object.values(o5);
    return values.length === dimension && values.every((v4) => isFinite(v4));
  };
  return (o5) => {
    return isVectorArray.test(o5) || isVectorObject(o5);
  };
}
...
var isNumberSettings = (o5) => !!o5 && ("step" in o5 || "min" in o5 || "max" in o5);
...
var h2 = function(r4) {
  var t4 = r4.r, n4 = r4.g, e4 = r4.b, u4 = r4.a, a4 = Math.max(t4, n4, e4), o5 = a4 - Math.min(t4, n4, e4), i4 = o5 ? a4 === t4 ? (n4 - e4) / o5 : a4 === n4 ? 2 + (e4 - t4) / o5 : 4 + (t4 - n4) / o5 : 0;
  return { h: 60 * (i4 < 0 ? i4 + 6 : i4), s: a4 ? o5 / a4 * 100 : 0, v: a4 / 255 * 100, a: u4 };
};
var b2 = function(r4) {
  var t4 = r4.h, n4 = r4.s, e4 = r4.v, u4 = r4.a;
  t4 = t4 / 360 * 6, n4 /= 100, e4 /= 100;
  var a4 = Math.floor(t4), o5 = e4 * (1 - n4), i4 = e4 * (1 - (t4 - a4) * n4), s4 = e4 * (1 - (1 - t4 + a4) * n4), h4 = a4 % 6;
  return { r: 255 * [e4, i4, o5, o5, s4, e4][h4], g: 255 * [s4, e4, e4, i4, o5, o5][h4], b: 255 * [o5, o5, s4, e4, e4, i4][h4], a: u4 };
};
var g2 = function(r4) {
...
var y2 = { string: [[function(r4) {
  ...
  var n4 = r4.r, e4 = r4.g, u4 = r4.b, o5 = r4.a, i4 = void 0 === o5 ? 1 : o5;
  return t2(n4) && t2(e4) && t2(u4) ? a2({ r: Number(n4), g: Number(e4), b: Number(u4), a: Number(i4) }) : null;
}, "rgb"], [function(r4) {
  var n4 = r4.h, e4 = r4.s, u4 = r4.l, a4 = r4.a, o5 = void 0 === a4 ? 1 : a4;
  if (!t2(n4) || !t2(e4) || !t2(u4))
    return null;
  var i4 = g2({ h: Number(n4), s: Number(e4), l: Number(u4), a: Number(o5) });
  return f2(i4);
}, "hsl"], [function(r4) {
  var n4 = r4.h, a4 = r4.s, o5 = r4.v, i4 = r4.a, s4 = void 0 === i4 ? 1 : i4;
  if (!t2(n4) || !t2(a4) || !t2(o5))
    return null;
  var h4 = function(r5) {
    return { h: u2(r5.h), s: e2(r5.s, 0, 100), v: e2(r5.v, 0, 100), a: e2(r5.a) };
  }({ h: Number(n4), s: Number(a4), v: Number(o5), a: Number(s4) });
  return b2(h4);
}, "hsv"]] };
...
function names_default(e4, f4) {
  ...
  e4.prototype.toName = function(f5) {
    ...
    if (null == f5 ? void 0 : f5.closest) {
      var o5 = this.toRgb(), t4 = 1 / 0, b4 = "black";
      if (!l4.length)
        for (var c4 in a4)
          l4[c4] = new e4(a4[c4]).toRgb();
      for (var g4 in a4) {
        var u4 = (d5 = o5, i4 = l4[g4], Math.pow(d5.r - i4.r, 2) + Math.pow(d5.g - i4.g, 2) + Math.pow(d5.b - i4.b, 2));
        u4 < t4 && (t4 = u4, b4 = g4);
      }
      return b4;
    }
...
function c3(e4, r4) {
  if (null == e4)
    return {};
  var t4, n4, o5 = {}, a4 = Object.keys(e4);
  for (n4 = 0; n4 < a4.length; n4++)
    r4.indexOf(t4 = a4[n4]) >= 0 || (o5[t4] = e4[t4]);
  return o5;
}
function i3(e4) {
...
var d3 = function(e4, r4, t4) {
  var n4 = e4.getBoundingClientRect(), o5 = f3(r4) ? function(e5, r5) {
    for (var t5 = 0; t5 < e5.length; t5++)
      if (e5[t5].identifier === r5)
        return e5[t5];
    return e5[0];
  }(r4.touches, t4) : r4;
  return { left: s3((o5.pageX - (n4.left + v3(e4).pageXOffset)) / n4.width), top: s3((o5.pageY - (n4.top + v3(e4).pageYOffset)) / n4.height) };
};
var h3 = function(e4) {
  !f3(e4) && e4.preventDefault();
};
var m3 = import_react22.default.memo(function(o5) {
  var a4 = o5.onMove, l4 = o5.onKey, s4 = c3(o5, ["onMove", "onKey"]), m4 = (0, import_react22.useRef)(null), g4 = i3(a4), p4 = i3(l4), b4 = (0, import_react22.useRef)(null), _2 = (0, import_react22.useRef)(false), x3 = (0, import_react22.useMemo)(function() {
    var e4 = function(e5) {
    ...
    function t4(t5) {
      var n4 = _2.current, o6 = v3(m4.current), a5 = t5 ? o6.addEventListener : o6.removeEventListener;
    ...
    return [function(e5) {
      ...
      if (n4 && (h3(r5), !function(e6, r6) {
        ...
        if (f3(r5)) {
          _2.current = true;
          var o6 = r5.changedTouches || [];
          o6.length && (b4.current = o6[0].identifier);
        }
...
var p3 = function(r4) {
  var t4 = r4.color, n4 = r4.left, o5 = r4.top, a4 = void 0 === o5 ? 0.5 : o5, l4 = g3(["react-colorful__pointer", r4.className]);
...
var y3 = function(e4) {
  var r4 = e4.s, t4 = e4.v, n4 = e4.a, o5 = (200 - r4) * t4 / 100;
  return { h: b3(e4.h), s: b3(o5 > 0 && o5 < 200 ? r4 * t4 / 100 / (o5 <= 100 ? o5 : 200 - o5) * 100 : 0), l: b3(o5 / 2), a: b3(n4, 2) };
};
var q2 = function(e4) {
  var r4 = y3(e4);
...
var I3 = function(e4) {
  var r4 = e4.h, t4 = e4.s, n4 = e4.v, o5 = e4.a;
  r4 = r4 / 360 * 6, t4 /= 100, n4 /= 100;
  var a4 = Math.floor(r4), l4 = n4 * (1 - t4), u4 = n4 * (1 - (r4 - a4) * t4), c4 = n4 * (1 - (1 - r4 + a4) * t4), i4 = a4 % 6;
  return { r: b3(255 * [n4, u4, l4, l4, c4, n4][i4]), g: b3(255 * [c4, n4, n4, u4, l4, l4][i4]), b: b3(255 * [l4, l4, c4, n4, n4, u4][i4]), a: b3(o5, 2) };
};
var L2 = function(e4) {
  var r4 = e4.r, t4 = e4.g, n4 = e4.b, o5 = e4.a, a4 = Math.max(r4, t4, n4), l4 = a4 - Math.min(r4, t4, n4), u4 = l4 ? a4 === r4 ? (t4 - n4) / l4 : a4 === t4 ? 2 + (n4 - r4) / l4 : 4 + (r4 - t4) / l4 : 0;
  return { h: b3(60 * (u4 < 0 ? u4 + 6 : u4)), s: b3(a4 ? l4 / a4 * 100 : 0), v: b3(a4 / 255 * 100), a: o5 };
};
var S3 = import_react22.default.memo(function(r4) {
  var t4 = r4.hue, n4 = r4.onChange, o5 = g3(["react-colorful__hue", r4.className]);
  return import_react22.default.createElement("div", { className: o5 }, import_react22.default.createElement(m3, { onMove: function(e4) {
    n4({ h: 360 * e4.left });
  }, onKey: function(e4) {
...
var T2 = import_react22.default.memo(function(r4) {
  var t4 = r4.hsva, n4 = r4.onChange, o5 = { backgroundColor: q2({ h: t4.h, s: 100, v: 100, a: 1 }) };
  return import_react22.default.createElement("div", { className: "react-colorful__saturation", style: o5 }, import_react22.default.createElement(m3, { onMove: function(e4) {
...
var U2 = function(t4) {
  var n4 = t4.className, o5 = t4.colorModel, a4 = t4.color, l4 = void 0 === a4 ? o5.defaultColor : a4, i4 = t4.onChange, s4 = c3(t4, ["className", "colorModel", "color", "onChange"]), f4 = (0, import_react22.useRef)(null);
  Q(f4);
  var v4 = Y2(o5, l4, i4), d4 = v4[0], h4 = v4[1], m4 = g3(["react-colorful", n4]);
...
var ee = function(r4) {
  var t4 = r4.className, n4 = r4.hsva, o5 = r4.onChange, a4 = { backgroundImage: "linear-gradient(90deg, " + k3(Object.assign({}, n4, { a: 0 })) + ", " + k3(Object.assign({}, n4, { a: 1 })) + ")" }, l4 = g3(["react-colorful__alpha", t4]), u4 = b3(100 * n4.a);
...
var schema$22 = (o5) => v8n_esm_default().color().test(o5);
...
var schema2 = (o5, s4) => v8n_esm_default().array().length(2).every.number().test(o5) && v8n_esm_default().schema({
  min: number2,
  max: number2
}).test(s4);
var format2 = (v4) => ({
...
function getValue(o5) {
  return typeof o5 === "function" ? o5() : o5.current;
}
function Monitor({
  label,
  objectOrFn,
...
var TreeWrapper = import_react24.default.memo(({
  ...
  const store = useStoreContext();
  const getOrder = ([key, o5]) => {
    var _store$getInput;
    const order = isInput(o5) ? (_store$getInput = store.getInput(o5.path)) === null || _store$getInput === void 0 ? void 0 : _store$getInput.order : store.getFolderSettings(join(parent, key)).order;
    return order || 0;
  };
...
var _r = (l4, i4, n4) => i4 in l4 ? Cr(l4, i4, { enumerable: true, configurable: true, writable: true, value: n4 }) : l4[i4] = n4;
var qe = (l4, i4, n4) => (_r(l4, typeof i4 != "symbol" ? i4 + "" : i4, n4), n4);
var _e = { exports: {} };
var re2 = {};
var Je;
function Vr() {
  return Je || (Je = 1, function() {
    var l4 = import_react27.default, i4 = Symbol.for("react.element"), n4 = Symbol.for("react.portal"), c4 = Symbol.for("react.fragment"), m4 = Symbol.for("react.strict_mode"), R3 = Symbol.for("react.profiler"), d4 = Symbol.for("react.provider"), S4 = Symbol.for("react.context"), g4 = Symbol.for("react.forward_ref"), V3 = Symbol.for("react.suspense"), C2 = Symbol.for("react.suspense_list"), B2 = Symbol.for("react.memo"), A2 = Symbol.for("react.lazy"), W2 = Symbol.for("react.offscreen"), K = Symbol.iterator, I4 = "@@iterator";
    function N3(e4) {
    ...
    var U3 = l4.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    function y4(e4) {
      {
        for (var r4 = arguments.length, t4 = new Array(r4 > 1 ? r4 - 1 : 0), a4 = 1; a4 < r4; a4++)
          t4[a4 - 1] = arguments[a4];
        ne("error", e4, t4);
      }
    }
    function ne(e4, r4, t4) {
      {
        var a4 = U3.ReactDebugCurrentFrame, f4 = a4.getStackAddendum();
        f4 !== "" && (r4 += "%s", t4 = t4.concat([f4]));
        var v4 = t4.map(function(s4) {
          return String(s4);
        });
        v4.unshift("Warning: " + r4), Function.prototype.apply.call(console[e4], console, v4);
      }
    }
    var x3 = false, G2 = false, pe = false, Z2 = false, L3 = false, D2;
    D2 = Symbol.for("react.module.reference");
    function p4(e4) {
      return !!(typeof e4 == "string" || typeof e4 == "function" || e4 === c4 || e4 === R3 || L3 || e4 === m4 || e4 === V3 || e4 === C2 || Z2 || e4 === W2 || x3 || G2 || pe || typeof e4 == "object" && e4 !== null && (e4.$$typeof === A2 || e4.$$typeof === B2 || e4.$$typeof === d4 || e4.$$typeof === S4 || e4.$$typeof === g4 || // This needs to include all possible module reference object
      // types supported by any Flight configuration anywhere since
      // we don't know which Flight build this will end up being used
      // with.
      e4.$$typeof === D2 || e4.getModuleId !== void 0));
    }
    function E2(e4, r4, t4) {
      var a4 = e4.displayName;
      if (a4)
        return a4;
      var f4 = r4.displayName || r4.name || "";
      return f4 !== "" ? t4 + "(" + f4 + ")" : t4;
    }
    function w3(e4) {
    ...
    function F3(e4) {
      if (e4 == null)
        return null;
      if (typeof e4.tag == "number" && y4("Received an unexpected object in getComponentNameFromType(). This is likely a bug in React. Please file an issue."), typeof e4 == "function")
      ...
      if (typeof e4 == "object")
        switch (e4.$$typeof) {
          case S4:
            var r4 = e4;
            return w3(r4) + ".Consumer";
          case d4:
            var t4 = e4;
            return w3(t4._context) + ".Provider";
          case g4:
            return E2(e4, e4.render, "ForwardRef");
          case B2:
            var a4 = e4.displayName || null;
            return a4 !== null ? a4 : F3(e4.type) || "Memo";
          case A2: {
            var f4 = e4, v4 = f4._payload, s4 = f4._init;
            try {
              return F3(s4(v4));
            } catch {
              return null;
    ...
    var P2 = Object.assign, $4 = 0, ae, Se, De, Fe, Pe, Oe, ke;
    function Be() {
    }
    ...
    function Qe() {
      {
        ...
        $4 < 0 && y4("disabledDepth fell below zero. This is a bug in React. Please file an issue.");
      }
    }
    var me = U3.ReactCurrentDispatcher, ge;
    function oe(e4, r4, t4) {
      {
        if (ge === void 0)
          try {
            throw Error();
          } catch (f4) {
            var a4 = f4.stack.trim().match(/\n( *(at )?)/);
            ge = a4 && a4[1] || "";
          }
        return `
` + ge + e4;
    ...
    function je(e4, r4) {
      ...
      var a4;
      ye = true;
      var f4 = Error.prepareStackTrace;
      Error.prepareStackTrace = void 0;
      var v4;
      v4 = me.current, me.current = null, Ze();
      try {
        if (r4) {
          var s4 = function() {
            throw Error();
          };
          if (Object.defineProperty(s4.prototype, "props", {
            set: function() {
              throw Error();
            }
          }), typeof Reflect == "object" && Reflect.construct) {
            try {
              Reflect.construct(s4, []);
            } catch (z2) {
              a4 = z2;
            }
            Reflect.construct(e4, [], s4);
          } else {
            try {
              s4.call();
            } catch (z2) {
        ...
        if (z2 && a4 && typeof z2.stack == "string") {
          for (var u4 = z2.stack.split(`
`), _2 = a4.stack.split(`
`), h4 = u4.length - 1, b4 = _2.length - 1; h4 >= 1 && b4 >= 0 && u4[h4] !== _2[b4]; )
            b4--;
          for (; h4 >= 1 && b4 >= 0; h4--, b4--)
            if (u4[h4] !== _2[b4]) {
              if (h4 !== 1 || b4 !== 1)
                do
                  if (h4--, b4--, b4 < 0 || u4[h4] !== _2[b4]) {
                    var O2 = `
` + u4[h4].replace(" at new ", " at ");
                    return e4.displayName && O2.includes("<anonymous>") && (O2 = O2.replace("<anonymous>", e4.displayName)), typeof e4 == "function" && ie.set(e4, O2), O2;
                  }
                while (h4 >= 1 && b4 >= 0);
              break;
            }
        ...
        ye = false, me.current = v4, Qe(), Error.prepareStackTrace = f4;
      }
      var q3 = e4 ? e4.displayName || e4.name : "", He = q3 ? oe(q3) : "";
      return typeof e4 == "function" && ie.set(e4, He), He;
    }
    function rr(e4, r4, t4) {
      return je(e4, false);
    }
    function tr(e4) {
      var r4 = e4.prototype;
      ...
      if (typeof e4 == "object")
        switch (e4.$$typeof) {
          case g4:
            return rr(e4.render);
          case B2:
            return ue(e4.type, r4, t4);
          case A2: {
            var a4 = e4, f4 = a4._payload, v4 = a4._init;
            try {
              return ue(v4(f4), r4, t4);
            } catch {
            }
          }
        }
    ...
    var le = Object.prototype.hasOwnProperty, Ve = {}, Ue = U3.ReactDebugCurrentFrame;
    function se(e4) {
      if (e4) {
        var r4 = e4._owner, t4 = ue(e4.type, e4._source, r4 ? r4.type : null);
        Ue.setExtraStackFrame(t4);
      } else
        Ue.setExtraStackFrame(null);
    }
    function nr(e4, r4, t4, a4, f4) {
      {
        var v4 = Function.call.bind(le);
        for (var s4 in e4)
          if (v4(e4, s4)) {
            var u4 = void 0;
            try {
              if (typeof e4[s4] != "function") {
                var _2 = Error((a4 || "React class") + ": " + t4 + " type `" + s4 + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof e4[s4] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw _2.name = "Invariant Violation", _2;
              }
              u4 = e4[s4](r4, s4, a4, t4, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (h4) {
              u4 = h4;
            }
            u4 && !(u4 instanceof Error) && (se(f4), y4("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", a4 || "React class", t4, s4, typeof u4), se(null)), u4 instanceof Error && !(u4.message in Ve) && (Ve[u4.message] = true, se(f4), y4("Failed %s type: %s", t4, u4.message), se(null));
          }
      }
    }
    ...
    function or(e4) {
      {
        var r4 = typeof Symbol == "function" && Symbol.toStringTag, t4 = r4 && e4[Symbol.toStringTag] || e4.constructor.name || "Object";
        return t4;
      }
    }
    function ir(e4) {
    ...
    function Ae(e4) {
      if (ir(e4))
        return y4("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", or(e4)), Le(e4);
    }
    var Q2 = U3.ReactCurrentOwner, ur = {
      key: true,
      ref: true,
      __self: true,
      __source: true
    ...
    function lr(e4) {
      if (le.call(e4, "ref")) {
        var r4 = Object.getOwnPropertyDescriptor(e4, "ref").get;
        if (r4 && r4.isReactWarning)
          return false;
      }
      return e4.ref !== void 0;
    }
    function sr(e4) {
      if (le.call(e4, "key")) {
        var r4 = Object.getOwnPropertyDescriptor(e4, "key").get;
        if (r4 && r4.isReactWarning)
          return false;
      }
      return e4.key !== void 0;
    }
    function cr(e4, r4) {
      if (typeof e4.ref == "string" && Q2.current && r4 && Q2.current.stateNode !== r4) {
        var t4 = F3(Q2.current.type);
        xe2[t4] || (y4('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', F3(Q2.current.type), e4.ref), xe2[t4] = true);
      }
    }
    function fr(e4, r4) {
      {
        var t4 = function() {
          Ie || (Ie = true, y4("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", r4));
        };
        t4.isReactWarning = true, Object.defineProperty(e4, "key", {
          get: t4,
          configurable: true
        });
      }
    ...
    function vr(e4, r4) {
      {
        var t4 = function() {
          ze || (ze = true, y4("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", r4));
        };
        t4.isReactWarning = true, Object.defineProperty(e4, "ref", {
          get: t4,
          configurable: true
        });
      }
    }
    var dr = function(e4, r4, t4, a4, f4, v4, s4) {
      var u4 = {
      ...
      return u4._store = {}, Object.defineProperty(u4._store, "validated", {
        configurable: false,
        enumerable: false,
        writable: true,
        value: false
      }), Object.defineProperty(u4, "_self", {
        configurable: false,
        enumerable: false,
        writable: false,
        value: a4
      }), Object.defineProperty(u4, "_source", {
        configurable: false,
        enumerable: false,
        writable: false,
        value: f4
      }), Object.freeze && (Object.freeze(u4.props), Object.freeze(u4)), u4;
    };
    function pr(e4, r4, t4, a4, f4) {
      {
        var v4, s4 = {}, u4 = null, _2 = null;
        t4 !== void 0 && (Ae(t4), u4 = "" + t4), sr(r4) && (Ae(r4.key), u4 = "" + r4.key), lr(r4) && (_2 = r4.ref, cr(r4, f4));
        for (v4 in r4)
          le.call(r4, v4) && !ur.hasOwnProperty(v4) && (s4[v4] = r4[v4]);
        if (e4 && e4.defaultProps) {
          var h4 = e4.defaultProps;
          for (v4 in h4)
            s4[v4] === void 0 && (s4[v4] = h4[v4]);
        }
        if (u4 || _2) {
          var b4 = typeof e4 == "function" ? e4.displayName || e4.name || "Unknown" : e4;
          u4 && fr(s4, b4), _2 && vr(s4, b4);
        }
        return dr(e4, u4, _2, f4, a4, Q2.current, s4);
      }
    }
    var be = U3.ReactCurrentOwner, Ye = U3.ReactDebugCurrentFrame;
    function H3(e4) {
      if (e4) {
        var r4 = e4._owner, t4 = ue(e4.type, e4._source, r4 ? r4.type : null);
        Ye.setExtraStackFrame(t4);
      } else
    ...
    Re = false;
    function we(e4) {
      return typeof e4 == "object" && e4 !== null && e4.$$typeof === i4;
    }
    function Me2() {
      {
        if (be.current) {
          var e4 = F3(be.current.type);
          if (e4)
            return `
...
Check the render method of \`` + e4 + "`.";
    ...
    function mr(e4) {
      {
        if (e4 !== void 0) {
          var r4 = e4.fileName.replace(/^.*[\\\/]/, ""), t4 = e4.lineNumber;
          return `

Check your code at ` + r4 + ":" + t4 + ".";
        }
        return "";
      }
    }
    ...
    function gr(e4) {
      {
        var r4 = Me2();
        if (!r4) {
          var t4 = typeof e4 == "string" ? e4 : e4.displayName || e4.name;
          t4 && (r4 = `

Check the top-level render call using <` + t4 + ">.");
        }
        return r4;
      }
    }
    function We(e4, r4) {
      {
        if (!e4._store || e4._store.validated || e4.key != null)
          return;
        ...
        $e[t4] = true;
        var a4 = "";
        e4 && e4._owner && e4._owner !== be.current && (a4 = " It was passed a child from " + F3(e4._owner.type) + "."), H3(e4), y4('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', t4, a4), H3(null);
      }
    }
    function Ne2(e4, r4) {
      {
        ...
        if (he(e4))
          ...
          e4._store && (e4._store.validated = true);
        else if (e4) {
          var f4 = N3(e4);
          if (typeof f4 == "function" && f4 !== e4.entries)
            for (var v4 = f4.call(e4), s4; !(s4 = v4.next()).done; )
              we(s4.value) && We(s4.value, r4);
        }
      }
    }
    function yr(e4) {
      {
        ...
        if (typeof r4 == "function")
          t4 = r4.propTypes;
        else if (typeof r4 == "object" && (r4.$$typeof === g4 || // Note: Memo only checks outer props here.
        ...
        if (t4) {
          var a4 = F3(r4);
          nr(t4, e4.props, "prop", a4, e4);
        } else if (r4.PropTypes !== void 0 && !Re) {
          Re = true;
          var f4 = F3(r4);
          y4("Component %s declared `PropTypes` instead of `propTypes`. Did you misspell the property assignment?", f4 || "Unknown");
        }
        typeof r4.getDefaultProps == "function" && !r4.getDefaultProps.isReactClassApproved && y4("getDefaultProps is only used on classic React.createClass definitions. Use a static property named `defaultProps` instead.");
      }
    }
    function hr(e4) {
      {
        for (var r4 = Object.keys(e4.props), t4 = 0; t4 < r4.length; t4++) {
          var a4 = r4[t4];
          if (a4 !== "children" && a4 !== "key") {
            H3(e4), y4("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", a4), H3(null);
            break;
          }
        }
        e4.ref !== null && (H3(e4), y4("Invalid attribute `ref` supplied to `React.Fragment`."), H3(null));
      }
    }
    function Ge(e4, r4, t4, a4, f4, v4) {
      {
        var s4 = p4(e4);
        if (!s4) {
          var u4 = "";
          (e4 === void 0 || typeof e4 == "object" && e4 !== null && Object.keys(e4).length === 0) && (u4 += " You likely forgot to export your component from the file it's defined in, or you might have mixed up default and named imports.");
          var _2 = mr(f4);
          _2 ? u4 += _2 : u4 += Me2();
          var h4;
          e4 === null ? h4 = "null" : he(e4) ? h4 = "array" : e4 !== void 0 && e4.$$typeof === i4 ? (h4 = "<" + (F3(e4.type) || "Unknown") + " />", u4 = " Did you accidentally export a JSX literal instead of a component?") : h4 = typeof e4, y4("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", h4, u4);
        }
        var b4 = pr(e4, r4, t4, f4, v4);
        if (b4 == null)
          return b4;
        if (s4) {
          var O2 = r4.children;
          if (O2 !== void 0)
            if (a4)
              if (he(O2)) {
                for (var q3 = 0; q3 < O2.length; q3++)
                  Ne2(O2[q3], e4);
                Object.freeze && Object.freeze(O2);
              } else
                y4("React.jsx: Static children should always be an array. You are likely explicitly calling React.jsxs or React.jsxDEV. Use the Babel transform instead.");
            else
              Ne2(O2, e4);
        }
        return e4 === c4 ? hr(b4) : yr(b4), b4;
      }
    }
    function xr(e4, r4, t4) {
      return Ge(e4, r4, t4, true);
    }
    function br(e4, r4, t4) {
      return Ge(e4, r4, t4, false);
    }
    var Rr = br, wr = xr;
    re2.Fragment = c4, re2.jsx = Rr, re2.jsxs = wr;
  }()), re2;
}
false ? _e.exports = jr() : _e.exports = Vr();
var X = _e.exports;
var ce = (l4) => {
  const i4 = new Color(l4);
  return new Vector3(i4.r, i4.g, i4.b);
};
...
var Lr = class extends Effect {
  constructor(n4 = {}) {
    const c4 = {
      tFluid: new Uniform(n4.tFluid),
      uDistort: new Uniform(n4.distortion),
      uRainbow: new Uniform(n4.rainbow),
      uIntensity: new Uniform(n4.intensity),
      uBlend: new Uniform(n4.blend),
      uShowBackground: new Uniform(n4.showBackground),
      uColor: new Uniform(ce(n4.fluidColor)),
      uBackgroundColor: new Uniform(ce(n4.backgroundColor))
    };
    super("FluidEffect", Ur, { uniforms: new Map(Object.entries(c4)) });
    qe(this, "state");
    this.state = {
      ...n4
    };
...
var Ar = (0, import_react27.forwardRef)(function(i4, n4) {
  const c4 = (0, import_react27.useMemo)(() => new Lr(i4), [i4]);
  return (0, import_react27.useEffect)(() => () => {
    c4 && c4.dispose();
  }, [c4]), X.jsx("primitive", { ref: n4, object: c4 });
});
var Ce2 = (l4, i4, n4) => {
  const c4 = useFBO(l4, i4, n4), m4 = useFBO(l4, i4, n4), R3 = (0, import_react27.useRef)({
    read: c4,
    write: m4,
    swap: () => {
      const d4 = R3.read;
      R3.read = R3.write, R3.write = d4;
    },
    dispose: () => {
      c4.dispose(), m4.dispose();
    }
  }).current;
  return R3;
};
...
var Ir = () => {
  const l4 = Ce2(o4.dyeRes, o4.dyeRes, {
    type: HalfFloatType,
    format: RGBAFormat,
    minFilter: LinearFilter,
    depth: false
  }), i4 = Ce2(o4.simRes, o4.simRes, {
    type: HalfFloatType,
    format: RGFormat,
    minFilter: LinearFilter,
    depth: false
  }), n4 = Ce2(o4.simRes, o4.simRes, {
    type: HalfFloatType,
    format: RedFormat,
    minFilter: NearestFilter,
    depth: false
  }), c4 = useFBO(o4.simRes, o4.simRes, {
    type: HalfFloatType,
    format: RedFormat,
    minFilter: NearestFilter,
    depth: false
  }), m4 = useFBO(o4.simRes, o4.simRes, {
    type: HalfFloatType,
    format: RedFormat,
    minFilter: NearestFilter,
    depth: false
  }), R3 = (0, import_react27.useMemo)(() => ({
    density: l4,
    velocity: i4,
    pressure: n4,
    divergence: c4,
  ...
  return (0, import_react27.useEffect)(() => () => {
    for (const d4 of Object.values(R3))
      d4.dispose();
  }, [R3]), R3;
};
...
var Xr = () => {
  const l4 = useThree((n4) => n4.size), i4 = (0, import_react27.useMemo)(() => {
    const n4 = new ShaderMaterial({
      uniforms: {
        uVelocity: {
          value: new Texture()
        },
      ...
      fragmentShader: Nr
    }), g4 = new ShaderMaterial({
      uniforms: {
        uTarget: {
          value: new Texture()
        },
        aspectRatio: {
          value: l4.width / l4.height
        },
        uColor: {
          value: new Vector3()
        },
    ...
    return {
      ...
      divergence: R3,
      pressure: S4,
      gradientSubstract: d4,
      advection: n4,
      vorticity: V3
    };
  }, [l4]);
  return (0, import_react27.useEffect)(() => {
    for (const n4 of Object.values(i4)) {
      const c4 = l4.width / (l4.height + 400);
      n4.uniforms.texelSize.value.set(1 / (o4.simRes * c4), 1 / o4.simRes), n4.vertexShader = zr, n4.depthTest = false, n4.depthWrite = false;
    }
    return () => {
      for (const n4 of Object.values(i4))
        n4.dispose();
...
var Jr = ({ force: l4 }) => {
  const i4 = useThree((d4) => d4.size), n4 = (0, import_react27.useRef)([]).current, c4 = (0, import_react27.useRef)(new Vector2()), m4 = (0, import_react27.useRef)(false);
  return { onPointerMove: (0, import_react27.useCallback)(
    (d4) => {
      const S4 = d4.x - c4.current.x, g4 = d4.y - c4.current.y;
      m4.current || (m4.current = true, c4.current.set(d4.x, d4.y)), c4.current.set(d4.x, d4.y), m4.current && n4.push({
        mouseX: d4.x / i4.width,
        mouseY: 1 - d4.y / i4.height,
        velocityX: S4 * l4,
        velocityY: -g4 * l4
      });
    },
    [l4, i4.height, i4.width, n4]
  ), splatStack: n4 };
};
var at = ({
  blend: l4 = o4.blend,
  ...
  curl: c4 = o4.curl,
  swirl: m4 = o4.swirl,
  intensity: R3 = o4.intensity,
  distortion: d4 = o4.distortion,
  fluidColor: S4 = o4.fluidColor,
  backgroundColor: g4 = o4.backgroundColor,
  showBackground: V3 = o4.showBackground,
  rainbow: C2 = o4.rainbow,
  pressure: B2 = o4.pressure,
  densityDissipation: A2 = o4.densityDissipation,
  velocityDissipation: W2 = o4.velocityDissipation
}) => {
  const K = useThree((E2) => E2.size), I4 = useThree((E2) => E2.gl), N3 = (0, import_react27.useMemo)(() => new Scene(), []), U3 = (0, import_react27.useMemo)(() => new Camera(), []), y4 = (0, import_react27.useRef)(null), ne = (0, import_react27.useRef)(null), x3 = Ir(), G2 = Xr(), { onPointerMove: pe, splatStack: Z2 } = Jr({ force: i4 }), L3 = (0, import_react27.useCallback)(
    (E2) => {
      y4.current && (y4.current.material = G2[E2], y4.current.material.needsUpdate = true);
    },
    [G2]
  ), D2 = (0, import_react27.useCallback)(
    (E2) => {
      const w3 = x3[E2];
      "write" in w3 ? (I4.setRenderTarget(w3.write), I4.clear(), I4.render(N3, U3), w3.swap()) : (I4.setRenderTarget(w3), I4.clear(), I4.render(N3, U3));
    },
    [U3, N3, x3, I4]
  ), p4 = (0, import_react27.useCallback)(
    (E2, w3, F3) => {
      const P2 = G2[E2];
      P2 && P2.uniforms[w3] && (P2.uniforms[w3].value = F3);
    },
    [G2]
  );
  return useFrame(({ gl: E2 }) => {
    if (!(!y4.current || !ne.current)) {
      for (let w3 = Z2.length - 1; w3 >= 0; w3--) {
        const { mouseX: F3, mouseY: P2, velocityX: $4, velocityY: ae } = Z2[w3];
        L3("splat"), p4("splat", "uTarget", x3.velocity.read.texture), p4("splat", "uPointer", new Vector2(F3, P2)), p4("splat", "uColor", new Vector3($4, ae, 10)), p4("splat", "uRadius", n4 / 100), D2("velocity"), p4("splat", "uTarget", x3.density.read.texture), D2("density"), Z2.pop();
      }
      L3("curl"), p4("curl", "uVelocity", x3.velocity.read.texture), D2("curl"), L3("vorticity"), p4("vorticity", "uVelocity", x3.velocity.read.texture), p4("vorticity", "uCurl", x3.curl.texture), p4("vorticity", "uCurlValue", c4), D2("velocity"), L3("divergence"), p4("divergence", "uVelocity", x3.velocity.read.texture), D2("divergence"), L3("clear"), p4("clear", "uTexture", x3.pressure.read.texture), p4("clear", "uClearValue", B2), D2("pressure"), L3("pressure"), p4("pressure", "uDivergence", x3.divergence.texture);
      for (let w3 = 0; w3 < m4; w3++)
        p4("pressure", "uPressure", x3.pressure.read.texture), D2("pressure");
      L3("gradientSubstract"), p4("gradientSubstract", "uPressure", x3.pressure.read.texture), p4("gradientSubstract", "uVelocity", x3.velocity.read.texture), D2("velocity"), L3("advection"), p4("advection", "uVelocity", x3.velocity.read.texture), p4("advection", "uSource", x3.velocity.read.texture), p4("advection", "uDissipation", W2), D2("velocity"), p4("advection", "uVelocity", x3.velocity.read.texture), p4("advection", "uSource", x3.density.read.texture), p4("advection", "uDissipation", A2), D2("density"), E2.setRenderTarget(null), E2.clear();
    }
    ...
    createPortal(
      X.jsx(
        "mesh",
        {
          ...
          children: X.jsx("planeGeometry", { args: [2, 2, 10, 10] })
        }
      ),
      N3
    ),
    X.jsx(
      Ar,
      {
        ...
        showBackground: V3,
        ref: ne,
        tFluid: x3.density.read.texture
      }
    )
  ] });
};
var ot = () => {
  const [l4, i4] = useControls("Settings", () => ({
    intensity: {
      value: o4.intensity,
      min: 0,
      max: 10,
...
@whatisjery/react-fluid-distortion/dist/index.es.js:
  (**
   * @license React
...
@whatisjery/react-fluid-distortion/dist/index.es.js:
   ...
   *)
*/
//# sourceMappingURL=@whatisjery_react-fluid-distortion.js.map
