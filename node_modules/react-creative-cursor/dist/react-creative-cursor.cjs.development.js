...
var Cursor = function Cursor(_ref) {
  var _ref$isGelly = _ref.isGelly,
      ...
      animationEase = _ref$animationEase === void 0 ? gsap.Expo.easeOut : _ref$animationEase,
      ...
      stickAnimationEase = _ref$stickAnimationEa === void 0 ? gsap.Power4.easeOut : _ref$stickAnimationEa,
      ...
      magneticAnimationEase = _ref$magneticAnimatio3 === void 0 ? gsap.Power4.easeOut : _ref$magneticAnimatio3,
      _ref$colorAnimationEa = _ref.colorAnimationEase,
      colorAnimationEase = _ref$colorAnimationEa === void 0 ? gsap.Power4.easeOut : _ref$colorAnimationEa,
      ...
      sizeAnimationEase = _ref$sizeAnimationEas === void 0 ? gsap.Expo.easeOut : _ref$sizeAnimationEas,
      ...
      textAnimationEase = _ref$textAnimationEas === void 0 ? gsap.Expo.easeOut : _ref$textAnimationEas,
  ...
  var cursorInner = React.useRef(null);
  ...
  var set = useInstance();
  React.useLayoutEffect(function () {
    set.x = gsap.gsap.quickSetter(cursor.current, 'x', 'px');
    set.y = gsap.gsap.quickSetter(cursor.current, 'y', 'px');

    if (isGelly) {
      set.r = gsap.gsap.quickSetter(cursor.current, 'rotate', 'deg');
      set.sx = gsap.gsap.quickSetter(cursor.current, 'scaleX');
      set.sy = gsap.gsap.quickSetter(cursor.current, 'scaleY');
      set.width = gsap.gsap.quickSetter(cursor.current, 'width', 'px');
      set.rt = gsap.gsap.quickSetter(cursorInner.current, 'rotate', 'deg');
    }
  });
  var loop = React.useCallback(function () {
  ...
  React.useLayoutEffect(function () {
    ...
    var setFromEvent = function setFromEvent(e) {
      ...
      gsap.gsap.set(pos, {});
      var xTo = gsap.gsap.quickTo(pos, 'x', {
        duration: duration,
        ease: ease,
      ...
      var yTo = gsap.gsap.quickTo(pos, 'y', {
        duration: duration,
        ease: ease,
        onUpdate: function onUpdate() {
    ...
    document.body.addEventListener('mouseenter', function (e) {
      if (e.target instanceof HTMLElement && cursor.current) {
        gsap.gsap.to("#" + cursor.current.id, {
          opacity: 1,
    ...
    textElements.forEach(function (el) {
      el.addEventListener('mouseenter', function (e) {
        if (e.target instanceof HTMLElement && cursorInner.current) {
          ...
          gsap.gsap.to("#" + cursorInner.current.id, {
            scale: 1,
            opacity: 1,
...
//# sourceMappingURL=react-creative-cursor.cjs.development.js.map
