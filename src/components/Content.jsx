    ...
    <>
      <Scroll html style={{ width: '100%', height: '100%' }}>
        ...
        <div className="ap" style={{ }} >
          <div className="awwards" style={{ position: 'absolute', transform: `translate3d(0,-100%,0)`, color: 'white', }}>

            <h1 style={{}}>Awwwards <span style={{  }}>34</span></h1>
            <svg style={{ width: '100%', }} width="100%" height="23" fill="none" xmlns="http://www.w3.org/2000/svg">
              <line x1="0" y1="0" x2="100%" y2="0" stroke="white" strokeWidth="4" />
            </svg>

            <div className="contentaward" style={{}}>
              <div style={{ display: "flex", justifyContent: 'space-between', }}>
                <h3 style={{}}>Site of the day</h3>
                <h3 style={{}}>09</h3>
              </div>

              <div style={{ display: "flex", justifyContent: 'space-between' }}>
                <h3 style={{}}>Honorable Mention</h3>
                <h3 style={{}}>09</h3>
              </div>

              <div style={{ display: "flex", justifyContent: 'space-between' }}>
                <h3 style={{}}>Mobile of the week</h3>
                <h3 style={{}}>09</h3>
              </div>

              <div style={{ display: "flex", justifyContent: 'space-between' }}>
                <h3 style={{}}>Ecommerce of the year</h3>
                <h3 style={{}}>09</h3>
              </div>
          ...
          <div id="Css" style={{ position: 'absolute', transform: `translate3d(0,-100%,0)`, color: 'white', }}>

            <h1 style={{}}>the CSS Design Awards <span style={{  }}>34</span></h1>
            <svg style={{ width: '100%', }} width="100%" height="23" fill="none" xmlns="http://www.w3.org/2000/svg">
              <line x1="0" y1="0" x2="100%" y2="0" stroke="white" strokeWidth="4" />
            </svg>
          ...
          <div id="Fwa" style={{ position: 'absolute', transform: `translate3d(0,-100%,0)`, color: 'white', }}>

            <h1 style={{}}>the FWA <span style={{}}>34</span></h1>
            <svg style={{ width: '100%', }} width="100%" height="23" fill="none" xmlns="http://www.w3.org/2000/svg">
              <line x1="0" y1="0" x2="100%" y2="0" stroke="white" strokeWidth="4" />
            </svg>
            <div className="contentaward" style={{}}>
